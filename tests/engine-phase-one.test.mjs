...
assert.ok(engineSnapshot.snapshotId.includes('duque-score-engine-v1.phase-51'), 'Engine snapshot should include engine version');
...
const legacySnapshot = {
  ...
  snapshotId: engineSnapshot.snapshotId.replace('phase-51', 'phase-16'),
};
...
console.log('DUQUE Engine Phase 1-51 tests passed');
