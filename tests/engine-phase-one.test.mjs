...
assert.ok(engineSnapshot.snapshotId.includes('duque-score-engine-v1.phase-52'), 'Engine snapshot should include engine version');
...
const legacySnapshot = {
  ...
  snapshotId: engineSnapshot.snapshotId.replace('phase-52', 'phase-16'),
};
...
console.log('DUQUE Engine Phase 1-52 tests passed');
