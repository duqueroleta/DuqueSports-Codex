...
assert.ok(engineSnapshot.snapshotId.includes('duque-score-engine-v1.phase-33'), 'Engine snapshot should include engine version');
...
const legacySnapshot = {
  ...
  snapshotId: engineSnapshot.snapshotId.replace('phase-33', 'phase-16'),
};
...
console.log('DUQUE Engine Phase 1-33 tests passed');
