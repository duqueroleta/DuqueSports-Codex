...
assert.ok(engineSnapshot.snapshotId.includes('duque-score-engine-v1.phase-32'), 'Engine snapshot should include engine version');
...
const legacySnapshot = {
  ...
  snapshotId: engineSnapshot.snapshotId.replace('phase-32', 'phase-16'),
};
...
console.log('DUQUE Engine Phase 1-32 tests passed');
