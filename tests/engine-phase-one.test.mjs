...
assert.ok(engineSnapshot.snapshotId.includes('duque-score-engine-v1.phase-34'), 'Engine snapshot should include engine version');
...
const legacySnapshot = {
  ...
  snapshotId: engineSnapshot.snapshotId.replace('phase-34', 'phase-16'),
};
...
console.log('DUQUE Engine Phase 1-34 tests passed');
